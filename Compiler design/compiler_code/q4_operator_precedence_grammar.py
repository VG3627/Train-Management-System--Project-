...
# No of lhs variables: 1
# 1st production : T->T+T|T*T|a
# Enter the operators : a+*
...
# No of lhs variables: 3
# 1st production : E->E+T|T
# 2nd production : T->T*V|V
# 3rd production : V->a|b|c|d
# Enter the operators : abcd+*
